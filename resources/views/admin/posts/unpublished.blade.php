...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Tin tức Không xuất bản</h3>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card mb-2">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{route('posts.unpublished')}}">
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3">
                                    ...
                                    <a href="{{route('posts.unpublished')}}" class="btn btn-dark">Làm mới</a>
                                </div>
                                    ...
                                    <tr role="row">
                                        ...
                                        <td class="text-center">
                                            @foreach($item->categories as $category)
                                                <span class="badge badge-outline-primary">{{$category['name']}}</span>
                                            @endforeach
                                        </td>
                                        <td class="text-center">
                                            @foreach($item->destinations as $destination)
                                                <span class="badge badge-outline-success">{{$destination['name']}}</span>
                                            @endforeach
                                        </td>
                                        <td class="text-center">
                                            {{$item->view}}
